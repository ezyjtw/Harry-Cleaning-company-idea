...
export type AuditAction =
  ...
  | 'DISPUTE_RESOLVED'
  | 'ADMIN_ACTION'
  | 'INCOMPLETE_SIGNUP_REMOVED'
  | 'ADMIN_SUSPEND_USER'
  | 'ADMIN_REACTIVATE_USER'
  | 'ADMIN_ASSIGN_CLEANER'
  | 'ADMIN_REASSIGN_BOOKING'
  | 'ADMIN_PRICE_ADJUST_REQUESTED'
  ...
  | 'RENA_FIND_ENTERED'
  | 'RENA_FIND_EXHAUSTED_ON_DECLINE'
  | 'RENA_FIND_ADMIN_REVIEW_ENTERED'
  // Stuck-money reaper actions
  | 'STUCK_JOB_CUSTOMER_ASKED'
  | 'STUCK_JOB_CUSTOMER_ANSWERED'
  | 'STUCK_JOB_FORCE_COMPLETED'
  | 'STUCK_JOB_CANCELLED_REFUNDED'
  | 'STUCK_JOB_RESOLVED_NO_REFUND'
  // Imported review actions
  | 'IMPORTED_REVIEW_SUBMITTED'
  | 'IMPORTED_REVIEW_EVIDENCE_UPLOADED'
  | 'IMPORTED_REVIEW_EVIDENCE_VIEWED'
  | 'IMPORTED_REVIEW_EVIDENCE_DESTROYED'
  | 'IMPORTED_REVIEW_VERIFIED'
