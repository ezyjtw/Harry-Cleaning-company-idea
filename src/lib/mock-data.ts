...
export const cleaners: Cleaner[] = [
  {
    ...
    timeSlots: {
      ...
      Wed: ['8:00 AM', '10:00 AM', '12:00 PM', '3:00 PM', '5:00 PM'],
      Thu: ['9:00 AM', '11:00 AM', '1:00 PM'],
      Fri: ['8:00 AM', '10:00 AM', '2:00 PM', '4:00 PM'],
    },
    availableNow: true,
    responseTime: '~5 min',
  ...
  },
  {
    ...
    specialties: ['Regular Cleaning', 'Deep Cleaning', 'Pet-Friendly'],
    languages: ['English'],
    tier: 'premium',
    location: 'Brixton, London',
    postcodeAreas: ['SW', 'SE', 'BR', 'CR'],
    verified: true,
    identityVerified: true,
    ...
    timeSlots: {
      Mon: ['7:00 AM', '9:00 AM', '11:00 AM', '2:00 PM'],
      Wed: ['8:00 AM', '10:00 AM', '1:00 PM', '3:00 PM', '5:00 PM'],
      Fri: ['9:00 AM', '12:00 PM', '3:00 PM'],
      Sat: ['8:00 AM', '10:00 AM', '12:00 PM'],
    },
    availableNow: false,
    responseTime: '~15 min',
  ...
  },
  {
    ...
    specialties: ['End of Tenancy', 'Deep Cleaning', 'Regular Cleaning'],
    languages: ['English', 'French'],
    tier: 'elite',
    location: 'Kensington, London',
    postcodeAreas: ['W', 'SW', 'NW', 'WC'],
    verified: true,
    identityVerified: true,
    backgroundChecked: true,
    yearsExperience: 10,
    ...
    timeSlots: {
      Tue: ['9:00 AM', '11:30 AM', '2:00 PM', '4:30 PM'],
      Thu: ['8:00 AM', '10:30 AM', '1:00 PM', '3:30 PM'],
      Sat: ['9:00 AM', '11:00 AM', '1:00 PM', '3:00 PM', '5:00 PM'],
  ...
  },
  {
    ...
    specialties: ['Regular Cleaning', 'Airbnb Cleaning', 'Deep Cleaning'],
    languages: ['English', 'Spanish'],
    tier: 'standard',
    location: 'Lewisham, London',
    postcodeAreas: ['SE', 'BR', 'DA', 'E'],
    verified: true,
    identityVerified: true,
    backgroundChecked: true,
    yearsExperience: 6,
    ...
    timeSlots: {
      Mon: ['7:00 AM', '9:00 AM', '11:00 AM', '1:00 PM', '3:00 PM', '5:00 PM'],
      Tue: ['7:00 AM', '9:00 AM', '11:00 AM', '1:00 PM', '3:00 PM'],
      Wed: ['8:00 AM', '10:00 AM', '12:00 PM', '2:00 PM', '4:00 PM'],
      Thu: ['7:00 AM', '9:00 AM', '11:00 AM', '1:00 PM'],
      Fri: ['8:00 AM', '10:00 AM', '12:00 PM', '2:00 PM', '4:00 PM', '6:00 PM'],
  ...
  },
  {
    ...
    timeSlots: {
      ...
      Wed: ['9:00 AM', '11:00 AM', '1:00 PM', '3:00 PM', '5:00 PM'],
      Thu: ['8:00 AM', '10:00 AM', '12:00 PM', '2:00 PM', '4:00 PM'],
  ...
  },
  {
    ...
    timeSlots: {
      Wed: ['9:00 AM', '11:00 AM', '2:00 PM', '4:00 PM'],
      Thu: ['8:00 AM', '10:00 AM', '12:00 PM', '3:00 PM'],
      Fri: ['9:00 AM', '11:00 AM', '1:00 PM', '3:00 PM', '5:00 PM'],
      Sat: ['8:00 AM', '10:00 AM', '12:00 PM', '2:00 PM', '4:00 PM'],
      Sun: ['10:00 AM', '12:00 PM', '2:00 PM'],
    },
    availableNow: false,
    responseTime: '~20 min',
