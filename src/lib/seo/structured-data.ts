...
export function generateOrganizationSchema() {
  return {
    ...
    description:
      'Book trusted, vetted cleaners in your area. Fair pricing with just 10% platform fee.',
    address: {
      '@type': 'PostalAddress',
...
export function generateLocalBusinessSchema(area: string) {
  return {
    ...
    description: `Professional cleaning services in ${area}. Book vetted cleaners with just 10% platform fee.`,
    address: {
      '@type': 'PostalAddress',
