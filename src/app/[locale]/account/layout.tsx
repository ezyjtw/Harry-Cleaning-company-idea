...
const navItems = [
  ...
  {
    // H42: customers had NO way back to a dispute they filed — /disputes was
    // reachable only via the post-report redirect. This is the entry point.
    // Like Messages, the disputes page lives at its own route (/disputes),
    // not under /account — the tab links out.
    label: 'Disputes',
    href: '/disputes',
