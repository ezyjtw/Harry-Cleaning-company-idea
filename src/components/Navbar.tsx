    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 md:px-14 md:py-5">
        ...
        <div className="relative">
          ...
          {/* Dropdown menu — compact on desktop, full-width on mobile */}
          {open && (
            <nav
              className="absolute right-0 top-full mt-4 w-screen bg-white border-t border-ink/5 md:w-[340px] md:border md:border-ink/10 md:shadow-lg"
