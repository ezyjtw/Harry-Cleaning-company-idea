import { Cleaner, Review, SavedAddress, PastBooking, CustomerReview } from "./types";
...
export const reviews: Review[] = [
  {
    ...
    cleanerReply: "Thank you so much, Sarah! It was a pleasure working in your home. Looking forward to next time!",
    date: "2026-02-28",
    verified: true,
  },
  {
  ...
  },
  {
    ...
    cleanerReply: "Thanks for the feedback, Linda! I'll make sure to spend extra time on the windows next visit.",
    date: "2026-02-10",
    verified: true,
  },
  {
  ...
  },
  {
    ...
    cleanerReply: "Thank you, Michelle! I always invest in the best equipment because my clients deserve the best results.",
    date: "2026-02-22",
    verified: true,
  },
];
...
export const customerReviews: CustomerReview[] = [
  {
    ...
    rating: 5,
    comment: "Wonderful client! Clean home, clear instructions, and very respectful. Would love to work with them again.",
    date: "2026-02-28",
  },
  {
    id: "cr2",
    ...
    rating: 4,
    comment: "Good client overall. Home was in reasonable condition. Would appreciate clearer parking instructions next time.",
    date: "2026-02-25",
  },
];
...
export const savedAddresses: SavedAddress[] = [
  ...
  { id: "a2", label: "Office", address: "456 Park Ave, Suite 200, Manhattan, NY 10022", isDefault: false },
];
