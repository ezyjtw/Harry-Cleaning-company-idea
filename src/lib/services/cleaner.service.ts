...
const mockCleanerProfile: Cleaner = {
  ...
  timeSlots: {
    ...
    Tuesday: ['8:00 AM', '10:00 AM', '12:00 PM', '2:00 PM'],
 ...
 */
export async function getAvailability(_cleanerId: string): Promise<AvailabilitySlot[]> {
...
export async function getEarnings(
  _cleanerId: string,
  _period: 'week' | 'month' | 'year' | 'custom'
