      ...
      <section className="bg-cream py-16">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 space-y-4 text-lg font-jost font-light text-ink-2 leading-relaxed">
            ...
            <p>
              We started Rena to fix this. Our platform takes just a 10% commission — enough to run
              a great service, but low enough that cleaners keep the vast majority of their
              earnings. This attracts the best cleaners, which means a better experience for you.
            </p>
            <p>
