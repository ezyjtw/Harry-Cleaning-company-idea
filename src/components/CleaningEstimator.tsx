      ...
      <div className="mt-6">
        ...
        <div className="mt-3 flex flex-wrap gap-3">
          ...
          <select
            ...
            onChange={(e) => setAddingRoom({ ...addingRoom, size: e.target.value as RoomDetail["size"] })}
            className="rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-200"
          >
          ...
          <select
            ...
            onChange={(e) => setAddingRoom({ ...addingRoom, condition: e.target.value as RoomDetail["condition"] })}
            className="rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-200"
          >
              ...
              {(() => {
                ...
                return (
                  <>
                    ...
                    <div className="text-xs text-gray-400">
                      ${breakdown.cleanerEarnings.toFixed(2)} to cleaner + ${breakdown.platformFee.toFixed(2)} fee
                    </div>
                  </>
                );
              })()}
              ...
              {estimate.breakdown.map((room, i) => (
                <div key={i} className="flex items-center justify-between text-sm">
                  ...
                  <div className="flex items-center gap-2">
                    {room.note && (
                      <span className="text-xs text-amber-600">{room.note}</span>
                    )}
