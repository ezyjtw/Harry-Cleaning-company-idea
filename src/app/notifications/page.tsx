...
const allMockNotifications: Notification[] = [
  // Today
  {
    ...
    body: 'Your cleaning with Sarah M. on March 18 at 10:00 AM has been confirmed. Your payment of £65.00 is held securely in escrow.',
    read: false,
  ...
  },
  {
    ...
    body: 'Your payment of £85.00 has been placed in escrow for booking #1042. The funds will be released to the cleaner once the job is completed.',
    read: false,
...
function getNotificationIcon(type: NotificationType): React.ReactNode {
  ...
  return (
    <div className={`flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full ${icon.bg}`}>
      <svg className={`${iconClass} ${icon.color}`} fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
