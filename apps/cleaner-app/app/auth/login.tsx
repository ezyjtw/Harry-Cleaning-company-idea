      ...
      <View style={styles.content}>
        <View style={styles.header}>
          <View style={styles.logo}>
            <Ionicons name="sparkles" size={32} color={Colors.primaryDark} />
          </View>
          <Text style={styles.title}>Cleaner Login</Text>
          <Text style={styles.subtitle}>Access your Rena cleaner dashboard</Text>
        </View>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>Want to become a cleaner?</Text>
