...
type VerifyStep = "start" | "document" | "selfie" | "liveness" | "processing" | "complete";
...
export default function VerifyPage() {
  ...
  const handleStartLiveness = () => {
    // Simulated progressive liveness checks
    setStep("liveness");
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <p className="mt-2 text-gray-600">
        ...
        This protects both cleaners and customers.
      </p>
        ...
        {[
          ...
          return (
            <div key={s.key} className="flex items-center gap-2 flex-1">
              ...
              {i < 2 && <div className={`flex-1 h-0.5 ${isActive ? "bg-brand-300" : "bg-gray-200"}`} />}
            </div>
          );
        })}
      </div>
      ...
      {step === "start" && (
        <div className="mt-8 space-y-6">
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-500">Verified cleaners get 3x more bookings</div>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-500">Everyone knows who they&apos;re meeting</div>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-500">Quick selfie confirms the right person shows up</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-lg bg-blue-50 border border-blue-200 p-4 text-sm text-blue-700">
            <strong>Privacy:</strong> Your ID is encrypted and only used for verification.
            We never share your documents with customers or cleaners.
            Verification data is deleted after 30 days.
          </div>
      ...
      {step === "selfie" && (
        <div className="mt-8 space-y-6">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Take a selfie so we can match your face to your ID document.
          ...
          >
            {selfieUploaded ? (
              <div>
                ...
                <p className="mt-2 text-sm font-medium text-green-700">
                  Selfie captured — face match confirmed
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="mt-2 text-sm text-gray-500">
                  Open camera and take a clear selfie
                </p>
                <p className="text-xs text-gray-400">
          ...
          <div className="rounded-lg bg-gray-50 p-4 text-sm text-gray-600">
            <strong>How face matching works:</strong> Our system compares your selfie to the photo on your ID.
            We use AI to verify it&apos;s the same person. This photo is also used for
      ...
      {step === "liveness" && (
        <div className="mt-8 space-y-6">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              This confirms you&apos;re a real person (not a photo of a photo).
              Follow the prompts — it only takes a few seconds.
            </p>
          </div>
      ...
      {step === "complete" && (
        <div className="mt-16 text-center">
          ...
          <p className="mt-3 text-gray-600">
            Your profile now shows the &quot;ID &amp; Background Verified&quot; badge.
            Customers will see this when booking and upon your arrival.
          </p>
          ...
          <div className="mt-6 rounded-lg bg-blue-50 border border-blue-200 p-4 text-sm text-blue-700 max-w-md mx-auto">
            <strong>Arrival verification:</strong> When you arrive at a customer&apos;s
            home, you&apos;ll take a quick selfie in the app. The customer sees it
