...
const mockNotifications: Notification[] = [
  ...
  },
  {
    ...
    body: 'Your payment of £85.00 has been placed in escrow.',
    read: false,
    ...
    case 'BOOKING_CONFIRMED':
      return (
        <div className="flex h-8 w-8 items-center justify-center rounded-full bg-green-100">
          <svg className={`${iconClass} text-green-600`} fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
    ...
    case 'BOOKING_CANCELLED':
      return (
        <div className="flex h-8 w-8 items-center justify-center rounded-full bg-red-100">
          <svg className={`${iconClass} text-red-600`} fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
    ...
    case 'BOOKING_REMINDER':
      return (
        <div className="flex h-8 w-8 items-center justify-center rounded-full bg-yellow-100">
          <svg className={`${iconClass} text-yellow-600`} fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
    ...
    case 'CLEANER_ASSIGNED':
      return (
        <div className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-100">
          <svg className={`${iconClass} text-blue-600`} fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
    ...
    case 'PAYMENT_RECEIVED':
      return (
        <div className="flex h-8 w-8 items-center justify-center rounded-full bg-emerald-100">
          <svg className={`${iconClass} text-emerald-600`} fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
    ...
    case 'REVIEW_RECEIVED':
      return (
        <div className="flex h-8 w-8 items-center justify-center rounded-full bg-amber-100">
          <svg className={`${iconClass} text-amber-600`} fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
    ...
    case 'MESSAGE_RECEIVED':
      return (
        <div className="flex h-8 w-8 items-center justify-center rounded-full bg-purple-100">
          <svg className={`${iconClass} text-purple-600`} fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
    ...
    case 'DISPUTE_UPDATE':
      return (
        <div className="flex h-8 w-8 items-center justify-center rounded-full bg-orange-100">
          <svg className={`${iconClass} text-orange-600`} fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
    ...
    default:
      return (
        <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gray-100">
          <svg className={`${iconClass} text-gray-600`} fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
