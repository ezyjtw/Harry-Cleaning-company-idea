...
const faqCategories = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: 'Unlike traditional cleaning agencies, Rena lets you choose your cleaner based on real reviews, ratings, and availability. We only charge a 10% platform commission plus a 5% service fee — far lower than the 20-30% industry standard — which means better rates for you and higher earnings for cleaners.',
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: 'No. Rena has a transparent pricing model. The price shown at checkout is the price you pay. Our 10% platform commission and 5% service fee are always shown separately before you confirm — there are no surprise charges.',
      },
      {
