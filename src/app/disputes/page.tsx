      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-2 text-gray-600">
            We take every dispute seriously. Both parties can submit evidence, and
        ...
        <div className="mt-6 rounded-lg bg-green-50 border border-green-200 p-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-green-700">
              ...
              The escrow payment is now frozen until resolution.
            </span>
          </div>
        </div>
      )}
        ...
        <form onSubmit={handleSubmitDispute} className="mt-8 space-y-6">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Please provide as much detail and evidence as possible. This helps us
              resolve disputes fairly for both parties.
            </p>
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setNewDispute({ ...newDispute, bookingId: e.target.value })
              }
              ...
              {DISPUTE_REASONS.map((reason) => (
                ...
                >
                  <input
                    ...
                    onChange={() =>
                      setNewDispute({ ...newDispute, reason: reason.value })
                    }
                    className="mt-0.5"
                  />
                  <div>
                  ...
                  {dispute.status === "under-review" && (
                    <div className="mt-4 rounded-lg bg-blue-50 border border-blue-200 p-3">
                      <p className="text-sm text-blue-700">
                        This dispute is under review. You can add additional evidence
                        or information to strengthen your case.
                      </p>
