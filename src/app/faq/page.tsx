...
const faqCategories = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: 'Unlike traditional cleaning agencies, Rena lets you choose your cleaner based on real reviews, ratings, and availability. We only add a small 5% service fee at checkout — far lower than the 20-30% markups charged by traditional agencies — which means better rates for you and higher earnings for cleaners.',
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: 'No. Rena has a transparent pricing model. The price shown at checkout is the price you pay. A 5% service fee is the only extra charge and it is always shown before you confirm — there are no surprise charges.',
      },
      {
