...
export default function AccountPage() {
  ...
  const [addresses, setAddresses] = useState<Address[]>([
    { id: '1', label: 'Home', line1: '42 Baker Street', city: 'London', postcode: 'NW1 6XE', isDefault: true },
    { id: '2', label: 'Office', line1: '10 Downing Street', city: 'London', postcode: 'SW1A 2AA', isDefault: false },
  ])
  const [showAddAddress, setShowAddAddress] = useState(false)
  const [newAddress, setNewAddress] = useState({ label: '', line1: '', line2: '', city: '', postcode: '' })
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        {showAddAddress && (
          <form onSubmit={handleAddAddress} className="mt-4 space-y-3 rounded-lg border border-gray-200 bg-gray-50 p-4">
            <div>
              <label htmlFor="addr-label" className="block text-sm font-medium text-gray-700">Label (e.g. Home, Office)</label>
              <input
                id="addr-label"
                type="text"
                required
            ...
            <div>
              <label htmlFor="addr-line2" className="block text-sm font-medium text-gray-700">Address Line 2 (optional)</label>
              <input
                id="addr-line2"
                type="text"
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                <label htmlFor="addr-postcode" className="block text-sm font-medium text-gray-700">Postcode</label>
                <input
                  id="addr-postcode"
                  type="text"
                  required
        ...
        {addresses.length === 0 ? (
          ...
          <ul className="mt-4 space-y-3">
            {addresses.map(addr => (
              <li key={addr.id} className="flex items-start justify-between rounded-lg border border-gray-200 p-3">
                <div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-md rounded-xl bg-white p-6 shadow-xl">
            ...
            <p className="mt-2 text-sm text-gray-600">
              This will permanently delete your account and all associated data including bookings, reviews, and payment history.
            </p>
