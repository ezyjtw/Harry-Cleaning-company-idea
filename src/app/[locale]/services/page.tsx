...
const services: {
  ...
  },
  {
    ...
    tagline: 'Coming soon',
    summary:
      "Same-day booking isn't available yet — we're building it. When it launches, you'll be able to get a vetted cleaner at short notice with the same standards as every Rena clean.",
    details: [
      'Coming soon — not yet bookable',
      'Same vetted cleaners, same standards',
      'Ideal for unexpected guests, viewings, or last-minute needs',
      'Watch this space — or book a next-day clean today',
    ],
    price: 'Coming soon',
